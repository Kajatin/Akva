...
//        model.showNotificationRequest = false
    ...
    func registerDrink(volume: Double, date: Date) {
        // Generate some random dummy inputs for the past few months
//        for _ in 0..<1000 {
//            let randomVolume = Int.random(in: 0..<350)
//            let randomDate = Date(timeIntervalSinceNow: -Double.random(in: 0..<86400*30*3))
//            let waterQuantitySample = healthStoreManager.generateQuantitySample(quantity: Double(randomVolume), date: randomDate)
